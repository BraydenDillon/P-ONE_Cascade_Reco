...
parser.add_argument("-i", "--infile", default="/mnt/research/IceCube/PONE/moudgil1_gen/test1_cascade/gen_cas_0050.i3.zst")
# parser.add_argument("-r", "--runnumber", type=int, default=1)
parser.add_argument(
    "-g", "--gcdfile", default="/mnt/research/IceCube/PONE/i3/MC/PONE_800mGrid_40mSpacing_40OMstring_PMTsphere.i3.gz"
)
...
def lazyfilter(frame):
    if frame['I3EventHeader'].event_id != 6:
        return False
    return frame['I3EventHeader'].event_id == 6
def mctruth(fr):
    fr["MCTruth"] = fr["I3MCTree"][0]
